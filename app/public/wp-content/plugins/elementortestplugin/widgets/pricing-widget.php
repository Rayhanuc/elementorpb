...
class Elementor_Pricing_Widget extends \Elementor\Widget_Base{
	...
	protected function render() {
		...
		$heading = $this->get_settings('h_title');
					...
					<div class="row mt-5 align-items-center">
						...
						<div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left">
							<div class="fdb-box fdb-touch p-5 rounded">
								...
								<p class="text-left pt-4"><a href="<?php echo esc_url( $pricing['button_url']['url'] ) ?>" class="btn btn-<?php echo esc_attr($button_class); ?>"><?php echo esc_html($pricing['button_title']); ?></a></p>
							</div>
						</div>
						<?php
						}
